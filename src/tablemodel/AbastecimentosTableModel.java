...
public class AbastecimentosTableModel extends AbstractTableModel {

    private static List<Abastecimento> linhas;
    private static String[] cColunas = new String[]{"Data/Hora", "Estação de Abastecimento", "Volume", "Veículo", "Odômetro/Horímetro", "Frota", "Empresa", "Operador", "Encerrante"};

    public AbastecimentosTableModel() {
        linhas = new ArrayList<>();
    }

    public AbastecimentosTableModel(List<Abastecimento> listaAbastecimentos) {
...
//            case 3:
//                return abastecimento.getTempoAbastecimento();
            case 3:
            ...
            case 4://odometro/horimetro
//                System.out.println(abastecimento.getIdAbastecimento() + "");
//                if (abastecimento.getIdAbastecimento() == 104) {
//                    System.out.println("");
//                }
                if ((abastecimento.getVeiculo() == null) || (abastecimento.getVeiculo().getTipo()==null)) {
                    return 0L;
                } else if (abastecimento.getVeiculo().getTipo().equals("O")) {
