...
import model.*;
import render.*;
import tablemodel.AlterarAbastecTableModel;
import util.*;
import bd.*;
...
public class ReimprimirCupomGUI extends javax.swing.JDialog {
    ...
    public ReimprimirCupomGUI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jplTituloLayout.setHorizontalGroup(
            ...
            .addGroup(jplTituloLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jlbTituloJanela, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel1.setText("Duplo clique para selecionar e visualizar o registro.");
        ...
        jbtSalvar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/impressora.png"))); // NOI18N
        jbtSalvar.setText("Reimprimir Cupom");
    ...
    public void mostrar(Abastecimento abastec) {
        ...
        if (abastec.getVeiculo() != null) {
            ...
            for (int i = 1; i < comboFrota.getItemCount(); i++) {
                Frota frotacombo = (Frota) comboFrota.getItemAt(i);
                Frota frotaAbastec = abastec.getVeiculo().getFrota();
                if (frotacombo.getSeqFrota() == frotaAbastec.getSeqFrota()) {
    ...
    private void jbtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtSalvarActionPerformed
        Abastecimento a = AbastecimentosDB.buscaAbastecimento(Integer.valueOf(seq.getText().trim()));
        try {
            ImprimirCupom.imprimirCupom(a,1);
        } catch (Exception e) {
            GeraLog g = new GeraLog();
            g.gravaErro(e);
            g.close();
...
public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ReimprimirCupomGUI dialog = new ReimprimirCupomGUI(new javax.swing.JFrame(), true);
    ...
    private void desabilitaCampos() {
        ...
        marcadorAtualField.setEnabled(false);
    }
