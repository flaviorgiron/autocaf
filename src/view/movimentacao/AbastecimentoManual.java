...
public class AbastecimentoManual extends JPanel {
...
//        nomebicoField.setDocument(new FixedLengthUpperDocument(100));
    ...
    private void initComponents() {
        ...
        jlbTituloCadastroExame2.setText("Registro Manual de Abastecimentos");
        ...
        nomebicoLabel2.setText("Odômetro/Horímetro");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(39, 39, 39)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(numeroAbastec, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private class FormListener implements java.awt.event.ActionListener, java.awt.event.MouseListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == jbtSalvar) {
                AbastecimentoManual.this.jbtSalvarActionPerformed(evt);
            }
            else if (evt.getSource() == jbtRecarregar) {
                AbastecimentoManual.this.jbtRecarregarActionPerformed(evt);
            }
            else if (evt.getSource() == jbtNovo) {
                AbastecimentoManual.this.jbtNovoActionPerformed(evt);
            }
            else if (evt.getSource() == jbtExcluir) {
                AbastecimentoManual.this.jbtExcluirActionPerformed(evt);
            }
        }

        public void mouseClicked(java.awt.event.MouseEvent evt) {
            if (evt.getSource() == masterTable) {
                AbastecimentoManual.this.masterTableMouseClicked(evt);
            }
        }
    ...
    private void jbtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtSalvarActionPerformed
        try {
            if (verificaCamposObrigatorios()) {
                ...
                if (AbastecimentosDB.insertOrUpdateAbastecimentoManual(a, true, "M")) {
                    jbtRecarregar.doClick();
                    jbtSalvar.setEnabled(false);
                    jbtSalvar.setEnabled(false);
                    jbtExcluir.setEnabled(false);
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            ...
            frame.setContentPane(new AbastecimentoManual());
    ...
    private void carregaGrid() {
        try {
            ...
            getModelAbastec().addListaAbastecimentos(AbastecimentosDB.buscaAbastecimentosManual("M"));
        } catch (Exception e) {
            GeraLog g = new GeraLog();
            g.gravaErro(e);
            g.close();
