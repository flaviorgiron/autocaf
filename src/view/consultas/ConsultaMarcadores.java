...
public class ConsultaMarcadores extends javax.swing.JDialog {

    public ConsultaMarcadores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jlbTituloJanela.setText("Consulta de Veículos");
    ...
    private void jbtVisualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtVisualizarActionPerformed
        try {
            ...
            fileJasper = this.getClass().getClassLoader().getResourceAsStream("relatorios/lista_veiculos.jasper");
...
public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ConsultaMarcadores dialog = new ConsultaMarcadores(new javax.swing.JFrame(), true);
